	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "images/logoslsu.png" width = "200px" height = "50px"/>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
				...
				<div class = "modal-dialog" role = "document">
					<div class = "modal-content panel-primary">
						...
						<form method = "POST" action = "save_student_query.php" enctype = "multipart/form-data">
							<div class  = "modal-body">
								...
								<div class = "form-group">
									<label>Age</label>
									<input type = "text" name = "age" required = "required" class = "form-control" />
								</div>
							<div class = "form-group">
								<label>Gender</label>
                  ...
                  <option value="Female">Female</option>
								...
								<div class = "form-group">
									...
									<input type = "date" name = "birthdate" required = "required" class = "form-control" />
								</div>
								<div class = "form-group">
									<label>Address</label>
			...
			<div class = "well col-lg-12">
				<button class = "btn btn-primary" type = "button" href = "#" data-toggle = "modal" data-target = "#add_student"><span class = "glyphicon glyphicon-user"></span> Add new </button>
				<br />
				<br />
		...
		<div class = "navbar navbar-fixed-bottom alert-warning">
			<div class = "container-fluid">
				<label class = "pull-left">&copy; STUDENT INFORMATION SYSTEM</label>
				<label class = "pull-right">All Rights Reserve 2019-2020</a></label>
			</div>	
		</div>	
	</body>
