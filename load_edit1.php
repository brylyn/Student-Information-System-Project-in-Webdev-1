...
<form method = "POST" action = "edit_student_query.php?student_id=<?php echo $f_edit_student['student_id']?>" enctype = "multipart/form-data">
	<div class  = "modal-body">
		...
		<div class = "form-group">
			<label>Course:</label>
			<input type = "text" name = "course" value = "<?php echo htmlentities($f_edit_student['course'])?>" required = "required" class = "form-control" />
		...
		<div class = "form-group">
			<label>Age</label>
			<input type = "text" name = "age" required = "required" value = "<?php echo $f_edit_student['age']?>" class = "form-control" />
		</div>
		<div class = "form-group">
			<label>Gender</label>
			<input type = "text" name = "gender" required = "required" value = "<?php echo $f_edit_student['gender']?>" class = "form-control" />
		</div>
		
		<div class = "form-group">
			<label>Birthdate</label>
			<input type = "date" name = "birthdate" required = "required" value = "<?php echo $f_edit_student['birthdate']?>" class = "form-control" />
		</div>
		<div class = "form-group">
			<label>Address</label>
			<input type = "text" name = "address" required = "required" value = "<?php echo $f_edit_student['address']?>" class = "form-control" />
		</div>
	</div>
