	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "well col-lg-12">
				<button type = "button" class = "btn btn-primary" data-target = "#myModal" data-toggle = "modal"><span class = "glyphicon glyphicon-user"></span> Add new</button>
				<br />
				<br />
		...
		<div class = "navbar navbar-fixed-bottom alert-warning">
			<div class = "container-fluid">
				...
				<label class = "pull-right">All rights reserved 2019-2020</a></label>
			</div>	
		</div>	
	</body>
